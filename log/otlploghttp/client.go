...
import (
	...
	"github.com/aluzzardi/otel-in-flight/log/otlploghttp/transform"
...
var _ log.LogExporter = (*client)(nil)

func NewClient(cfg Config) log.LogExporter {
...
func (d *client) ExportLogs(ctx context.Context, logs []*log.LogData) error {
