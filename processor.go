...
type TracerUpdater interface{ tracer() }
...
var _ trace.SpanProcessor = (*simpleSpanProcessor)(nil)
...
func (ssp *simpleSpanProcessor) OnEnd(s trace.ReadOnlySpan) {
	ssp.exporterMu.Lock()
	defer ssp.exporterMu.Unlock()
...
func (ssp *simpleSpanProcessor) Shutdown(ctx context.Context) error {
	...
	ssp.stopOnce.Do(func() {
		stopFunc := func(exp trace.SpanExporter) (<-chan error, func()) {
